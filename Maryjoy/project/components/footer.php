<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:123456789"><i class="fas fa-phone"></i> 0727  156 401</a>
         <a href="tel:234567891"><i class="fas fa-phone"></i> 0776 586 886</a>
         <a href="mailto:nyagahmaryjoy2@gmail.com"><i class="fas fa-envelope"></i> nyagahmaryjoy2@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Naivasha </a>
      </div>

      <div class="box">
         <h3>Follow Us</h3>
         <a href="https://www.facebook.com/maryjoynjeri" target="_blank"><i class="fab fa-facebook-f"></i>facebook</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Maryjoy Njeri Nyagah</span> | all rights reserved!</div>
